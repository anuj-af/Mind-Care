...
const HistoryCard: React.FC<HistoryCardProps> = ({
	...
	return (
		...
		>
			<Link
				to={`${id}`}
				className='w-full bg-tertiary border rounded-xl px-8 py-4 flex flex-col md:flex-row md:justify-between gap-4 items-center transition-all hover:border-secondaryDark hover:-translate-y-1 hover:shadow-md select-none'
			>
				<div
					className={`${
